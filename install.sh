...
wget https://raw.githubusercontent.com/osvynchuk/VerusCliMining/main/config.json -O ~/ccminer/config.json
wget https://raw.githubusercontent.com/osvynchuk/VerusCliMining/main/config_luckpool.json -O ~/ccminer/config_luckpool.json
wget https://raw.githubusercontent.com/osvynchuk/VerusCliMining/main/config_zerg_party.json -O ~/ccminer/config_zerg_party.json
